...
public class WaitUtility {
    ...
    public void safeNavigate(org.openqa.selenium.WebDriver driver, By navLinkLocator) {
        // Close any open modal first
        try {
            java.util.List<org.openqa.selenium.WebElement> closeBtn =
                    driver.findElements(org.openqa.selenium.By.cssSelector(".modal-content .close-btn"));
            if (!closeBtn.isEmpty()) {
        ...
        org.openqa.selenium.WebElement link = waitForClickable(navLinkLocator);
        try {
            link.click();
        } catch (Exception e) {
            ((org.openqa.selenium.JavascriptExecutor) driver)
    ...
    public void demoPause() {
        try {
            Thread.sleep(ConfigReader.DEMO_PAUSE_MS);
