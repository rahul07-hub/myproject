...
public class EmployeePage {
    ...
    public boolean isEmployeeAddedSuccessfully() {
        // The success banner shows briefly — try up to 8 seconds
        ...
        try {
            ...
            // Fallback: if we're still on /add-employee the form was likely submitted
            // (success state resets after 2.5s). Check toast or URL.
            try {
